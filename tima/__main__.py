...
def main():
    ...
    parser.add_argument('--output', '-o', dest="output", default="./",
                        type=str, help='Path to the desired output folder')
    parser.add_argument('--tima_version', '-t', dest="tima_version", choices=[
                        "1.4", "1.6"], default="1.6", type=str, help='Version of TIMA default 1.6, ')
