...
def tima_mindif_processor(project_path: str, mindif_root: str, output_root: str):
    ...
    for dataset in project_data.iterfind('DataSet'):
        guid_and_sample_name.append((dataset.find(
    ...
    for guid, sample_name in guid_and_sample_name:
        ...
        log_message('Extracting phases from {}'.format(phases_xml_path))
        ...
        profile_xml_path = os.path.join(mindif_path, 'measurement.xml')
        ...
        if sample_shape == "Rectangle":
            sample_width_um = int(measurement_nodes
                                  .find('SampleDef')
                                  .findtext('SampleWidth'))
            sample_height_um = int(measurement_nodes
                                   .find('SampleDef')
                                   .findtext('SampleHeight'))
            sample_width_px = int(
            ...
            # Must be a circle
            sample_diameter_um = int(measurement_nodes.find('SampleDef')
                                     .findtext('SampleDiameter'))
            diameter_px = int(
